...
namespace CRM.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public ProductoesController(CRMContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["CodigoFamilia"] = new SelectList(_context.Familia, "CodigoFamilia", "CodigoFamilia");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Codigo,CodigoFamilia,Nombre,PrecioEstandar,Estado,Descripcion")] Producto producto)
        {
            ...
            ViewData["CodigoFamilia"] = new SelectList(_context.Familia, "CodigoFamilia", "CodigoFamilia", producto.CodigoFamilia);
            return View(producto);
        }
